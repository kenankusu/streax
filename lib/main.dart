...
=======
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 0, 13, 255)),
      ),
      home: const MyHomePage(title: 'streax.'),
>>>>>>> 0cbe17c1102e23e4b918ab6ff080833cc785df46
    );
  }
}
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 12),
              buildGoalBar("80kg bis Oktober", 0.7),
              buildGoalBar("3x Training pro Woche", 0.3),
            ],
          ),
        ),
      ),
